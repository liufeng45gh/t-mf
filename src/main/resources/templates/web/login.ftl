...
<header id="header" style="display:block;">
    ...
    <span class="txt-header">用户登录</span>
</header>
<section class="page">
    ...
    <div class="wrap loginPage">
        ...
        <div  id="btn-submit" class="btn btn-active" >登录</div>

        <a   class="btn btn-to-login" style="display:block;" href="/register">->去注册/找回密码</a>
...
<script  src="/web/js/login.js?v=1.2"></script>
<script>
